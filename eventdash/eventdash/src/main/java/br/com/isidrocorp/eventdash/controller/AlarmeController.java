...
public class AlarmeController {
	...
	// aqui o Autowired é responsável por, além de buscar um objeto que
	// faz a implementação da interface, ele também cria a instanciação
	// do objeto ou seja, não preciso dar NEW
	...
	public ArrayList<Alarme> recuperarTodos(){
		...
		// basicamente ele deve entrar em contato com o banco de dadose fazer um SELECT
